...
`js/core/modules/integrales-lineales/index.js` es la implementacion activa de integrales trigonometria directa con argumento lineal. `js/core/integraleslineales.js` queda como fachada temporal para mantener compatibilidad con `window.TrigCore`, `require("./js/core/integraleslineales.js")` y el orden historico de carga.
