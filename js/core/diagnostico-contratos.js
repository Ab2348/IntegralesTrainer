(function (root) {
  ...
  const MESSAGES = {
    ...
    "missing-FAMILIES": "El modulo deberia exponer FAMILIES.",
    "missing-FAMILY_MAP": "El modulo deberia exponer FAMILY_MAP.",
    "missing-MODE_FAMILIES": "El modulo deberia exponer MODE_FAMILIES.",
    "missing-MATH_FAMILIES": "El modulo deberia exponer MATH_FAMILIES.",
    "missing-MATH_FAMILY_MAP": "El modulo deberia exponer MATH_FAMILY_MAP.",
    "missing-METHODS": "El modulo deberia exponer METHODS.",
    "missing-METHOD_MAP": "El modulo deberia exponer METHOD_MAP.",
    "missing-ERROR_TYPES": "El modulo deberia exponer ERROR_TYPES.",
    "missing-ERROR_TYPE_MAP": "El modulo deberia exponer ERROR_TYPE_MAP.",
  ...
  const RECOMMENDATIONS = {
    ...
    "missing-FAMILIES": "Exporta el catalogo de familias activo del modulo.",
    "missing-FAMILY_MAP": "Exporta un mapa por id para las familias del modulo.",
    "missing-MODE_FAMILIES": "Exporta los modos de practica y sus familias.",
    "missing-MATH_FAMILIES": "Exporta las familias matematicas activas del modulo.",
    "missing-MATH_FAMILY_MAP": "Exporta un mapa por id para familias matematicas.",
    "missing-METHODS": "Exporta los metodos activos del modulo.",
    "missing-METHOD_MAP": "Exporta un mapa por id para metodos.",
    "missing-ERROR_TYPES": "Exporta los tipos de error que puede producir el modulo.",
    "missing-ERROR_TYPE_MAP": "Exporta un mapa por id para tipos de error.",
